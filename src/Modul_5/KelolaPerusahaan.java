...
public class KelolaPerusahaan {
    public static void main(String[] args) {
        ...
        for (Pegawai daftarPegawai1 : daftarPegawai) {
            System.out.println("Nama: " + daftarPegawai1.getNama() + ", Jabatan: " + daftarPegawai1.getGolongan() + ", Gaji Pokok: " 
            + daftarPegawai1.getGajiPokok());
        }
...
if (pegawaiGajiTertinggi != null) {
    ...
    System.out.println("Nama: " + pegawaiGajiTertinggi.getNama() + ", Jabatan: " + pegawaiGajiTertinggi.getGolongan() + ", Gaji Pokok: " 
    + pegawaiGajiTertinggi.getGajiPokok());
...
if (pegawaiGajiTerendah != null) {
    System.out.println("Pegawai dengan Gaji tertinggi ");
    System.out.println("Nama: " + pegawaiGajiTerendah.getNama() + ", Jabatan: " + pegawaiGajiTerendah.getGolongan() + ", Gaji Pokok: " 
    + pegawaiGajiTerendah.getGajiPokok());
